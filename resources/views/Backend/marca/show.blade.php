    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-md-2">
              <div class="form-group bmd-form-group {{ $errors->has('publico') ? ' has-error' : '' }}">
                ...
                <label id="publico" class="form-check-label">
                  <input id="publicoval" name="publico"  class="form-check-input" type="checkbox" {{$marca->publico ? 'checked':''}} disabled>
                  Público
          ...
          <div class="row">
         <a class="btn btn-primary pull-right"  style="margin-left:25px;" href="{{ route('admin.marca.index')}}" >Salir</a>
         </div>
            </div>
          </div>
