                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td align="" style="font-family: Open Sans, Helvetica, Arial, sans-serif;">
                                                <h2 style="font-size: 20px; color: #444444; margin: 0; padding-bottom: 10px;">Mensaje Enviado </h2>
                                                <p style="color: #999999; font-size: 16px; line-height: 24px;">
                                                   <b>Su solicitud ha sido enviada correctamente</b> </p>

                                                    <p style="color: #999999; font-size: 16px; line-height: 24px;">
                                                   Gracias por comunicarte con nosotros. Pronto nos comunicaremos</p>
