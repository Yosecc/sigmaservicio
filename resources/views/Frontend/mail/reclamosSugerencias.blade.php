                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td align="" style="font-family: Open Sans, Helvetica, Arial, sans-serif;">
                                                <h2 style="font-size: 20px; color: #444444; margin: 0; padding-bottom: 10px;">Mensaje Recibido desde Pagina Web (Reclamos y Sugerencias) </h2>

                                                <p style="color: #999999; font-size: 16px; line-height: 24px;">
                                                   <b>Nombre y apellido: {{ $datos['nombre'] }}</b> 
                                                </p>
                                                <p style="color: #999999; font-size: 16px; line-height: 24px;">
                                                   <b>Mail: {{ $datos['email'] }}</b> 
                                                </p>
                                                <p style="color: #999999; font-size: 16px; line-height: 24px;">
                                                   <b>Telefono: {{ $datos['telefono'] }}</b> 
                                                </p>
                                                <p style="color: #999999; font-size: 16px; line-height: 24px;">
                                                   <b>Mensaje: {{ $datos['mensaje'] }}</b> 
                                                </p>
