<div class="contact prlx_parent">
	<div class="contact_background prlx" style="background-image: url(frontend/images/contact_background.jpg);"></div>
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1 text-center contact_text">
				...
				<div class="button contact_button">
					<a href="contact.html" class="d-flex flex-row align-items-center justify-content-center">contact<img src="{{ asset('frontend/images/arrow_right.svg') }}" alt=""></a>
				</div>
			</div>
		</div>
	</div>
